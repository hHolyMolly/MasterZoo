...
const watching = () => {
   ...
   gulp.watch(`${path.src}/fonts/**/*.{EOT,TTF,WOFF,WOFF2}`, fonts);
};

const mainTasks = gulp.parallel(html, js, scss, images, fonts);

const gulp_develop = gulp.series(clean, mainTasks, gulp.parallel(watching, server));
